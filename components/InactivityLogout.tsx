...
export default function InactivityLogout() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="bg-[#051210] border border-[#0f2d2a] rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4 text-center space-y-5">
        <div className="text-5xl">⏱️</div>
        <div>
          <h2 className="text-lg font-bold text-[#f0fdfa]">Brak aktywności</h2>
          <p className="text-sm text-[#4d9e94] mt-1">Zostaniesz automatycznie wylogowany za</p>
        </div>
