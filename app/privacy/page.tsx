...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-[#18140e] py-12 px-4">
      <div className="max-w-2xl mx-auto bg-[#241e14] rounded-xl shadow-lg shadow-black/30 border border-[#3a2e1e] p-8 space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-[#f0ebe0]">Polityka Prywatności</h1>
          <p className="text-sm text-[#7a6a58] mt-1">Panel Zarządzania Wspólnotą Mieszkaniową</p>
        </div>

        <section className="space-y-2">
          <h2 className="text-base font-semibold text-[#ddd5c5]">1. Administrator danych</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-[#ddd5c5]">2. Cel i podstawa przetwarzania</h2>
          <p className="text-sm text-[#7a6a58] leading-relaxed">
            Twoje dane (adres e-mail, imię i nazwisko, dane kontaktowe) przetwarzamy w celu:
          </p>
          <ul className="text-sm text-[#7a6a58] space-y-1 pl-4 list-disc">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-[#ddd5c5]">3. Okres przechowywania</h2>
          <p className="text-sm text-[#7a6a58] leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-[#ddd5c5]">4. Twoje prawa</h2>
          <p className="text-sm text-[#7a6a58] leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-[#ddd5c5]">5. Odbiorcy danych</h2>
          <p className="text-sm text-[#7a6a58] leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-[#ddd5c5]">6. Pliki cookies</h2>
          <p className="text-sm text-[#7a6a58] leading-relaxed">
        ...
        <div className="pt-2 border-t border-[#3a2e1e]">
