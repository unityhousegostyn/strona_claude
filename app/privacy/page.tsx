...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-6">
        <div>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-gray-800">1. Administrator danych</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-gray-800">2. Cel i podstawa przetwarzania</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-gray-800">3. Okres przechowywania</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-gray-800">4. Twoje prawa</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-gray-800">5. Odbiorcy danych</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-gray-800">6. Pliki cookies</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
