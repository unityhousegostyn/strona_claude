...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-stone-50 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-stone-100 rounded-xl shadow-lg shadow-black/30 border border-stone-200 p-8 space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-stone-900">Polityka Prywatności</h1>
          <p className="text-sm text-stone-500 mt-1">Panel Zarządzania Wspólnotą Mieszkaniową</p>
        </div>

        <section className="space-y-2">
          <h2 className="text-base font-semibold text-stone-800">1. Administrator danych</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-stone-800">2. Cel i podstawa przetwarzania</h2>
          <p className="text-sm text-stone-500 leading-relaxed">
            Twoje dane (adres e-mail, imię i nazwisko, dane kontaktowe) przetwarzamy w celu:
          </p>
          <ul className="text-sm text-stone-500 space-y-1 pl-4 list-disc">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-stone-800">3. Okres przechowywania</h2>
          <p className="text-sm text-stone-500 leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-stone-800">4. Twoje prawa</h2>
          <p className="text-sm text-stone-500 leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-stone-800">5. Odbiorcy danych</h2>
          <p className="text-sm text-stone-500 leading-relaxed">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-stone-800">6. Pliki cookies</h2>
          <p className="text-sm text-stone-500 leading-relaxed">
