  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#0d1410]">
      <div className="bg-[#121c15] shadow-2xl shadow-black/40 rounded-xl p-8 w-full max-w-sm space-y-5">
        <div>
          <h1 className="text-2xl font-bold text-[#d1fae5]">Reset hasła</h1>
          <p className="text-sm text-[#4d7a5f] mt-1">Wyślemy Ci link do ustawienia nowego hasła.</p>
        </div>
        ...
        {sent ? (
          ...
          <>
            ...
            <div className="text-center">
              <Link href="/login" className="text-sm text-[#4d7a5f] hover:underline">
                Wróć do logowania
              </Link>
            </div>
          </>
