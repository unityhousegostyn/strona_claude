    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[#18140e] border border-[#3a2e1e] rounded-2xl w-full max-w-md shadow-2xl">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#3a2e1e]">
              <h3 className="text-base font-semibold text-[#f0ebe0]">Dodaj użytkownika</h3>
              <button onClick={() => setOpen(false)} className="text-[#6a5a48] hover:text-[#b8a898] text-xl leading-none">×</button>
            </div>
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
                <div>
                  <label className="block text-xs text-[#7a6a58] mb-1">Imię i nazwisko</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-xs text-[#7a6a58] mb-1">Adres e-mail</label>
                  <input
                    type="email"
                    required
                    className="input w-full"
                ...
                <div>
                  <label className="block text-xs text-[#7a6a58] mb-1">Hasło tymczasowe</label>
                  <input
                    type="password"
                    required
                    minLength={8}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs text-[#7a6a58] mb-1">Rola</label>
                    <select
                      className="input w-full"
                      value={form.role}
                  ...
                  <div>
                    <label className="block text-xs text-[#7a6a58] mb-1">Wspólnota</label>
                    {isSuperAdmin ? (
                      <select
                        className="input w-full"
                      ...
                      <p className="input w-full text-[#7a6a58] text-sm py-2">
                ...
                <div className="flex justify-end gap-3 pt-1">
                  <button
                    ...
                    className="text-sm text-[#7a6a58] hover:text-[#ddd5c5] transition px-3 py-2"
                  >
                    Anuluj
                  </button>
                  <button
