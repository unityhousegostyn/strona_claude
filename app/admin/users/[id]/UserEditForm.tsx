  ...
  return (
    <div className="space-y-4">
      <div className="bg-[#1e1409] border border-[#33200d] rounded-xl p-5 space-y-4">
        <h3 className="text-xs font-semibold text-[#b45309] uppercase tracking-wide">Edytuj dane</h3>

        <div>
          <label className="block text-sm font-medium text-[#fde68a] mb-1">Imię i nazwisko</label>
          <input
            className="input"
            value={fullName}
        ...
        <div>
          <label className="block text-sm font-medium text-[#fde68a] mb-1">Rola</label>
          <select
            className="input"
            value={role}
          ...
          {isSelf && <p className="text-xs text-[#b45309] mt-1">Nie możesz zmienić własnej roli.</p>}
        </div>

        {role !== 'super_admin' && (
          <div>
            <label className="block text-sm font-medium text-[#fde68a] mb-1">Wspólnota</label>
            <select
              className="input"
              value={communityId}
      ...
      <div className="bg-[#1e1409] border border-[#33200d] rounded-xl p-5 space-y-4">
        <h3 className="text-xs font-semibold text-[#b45309] uppercase tracking-wide">Przypisane mieszkanie</h3>
        <div>
          <label className="block text-sm font-medium text-[#fde68a] mb-1">Lokal</label>
        ...
        <p className="text-xs text-[#a16207]">Jeden użytkownik = jedno mieszkanie. Mieszkanie zapisuje się razem z resztą danych przyciskiem poniżej.</p>
      </div>
