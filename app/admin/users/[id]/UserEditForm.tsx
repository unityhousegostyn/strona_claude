        ...
        {!isSelf && (
          <div className="flex gap-2">
            <button
              ...
              disabled={isPending}
              className="text-sm text-yellow-600 hover:text-yellow-700 font-medium px-4 py-2.5 rounded-lg border border-yellow-200 hover:bg-yellow-50 transition disabled:opacity-50"
            >
              Dezaktywuj
            </button>
            <button
              ...
              disabled={isPending}
              className="text-sm text-red-600 hover:text-red-700 font-medium px-4 py-2.5 rounded-lg border border-red-200 hover:bg-red-50 transition disabled:opacity-50"
            >
              Usuń konto
            </button>
          </div>
