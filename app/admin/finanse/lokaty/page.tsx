...
export default async function LokatyPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h2 className="text-2xl font-bold text-[#ecfdf5]">Lokaty i konta oszczędnościowe</h2>
        <p className="text-sm text-[#4d7a5f] mt-1">Zarządzaj środkami ulokowanymi w bankach — lokaty terminowe i konta oszczędnościowe</p>
      </div>
      <LokatyClient
