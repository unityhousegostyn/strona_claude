...
export default async function LokatyPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h2 className="text-2xl font-bold text-[#f0ebe0]">Lokaty i konta oszczędnościowe</h2>
        <p className="text-sm text-[#6a5a48] mt-1">Zarządzaj środkami ulokowanymi w bankach — lokaty terminowe i konta oszczędnościowe</p>
      </div>
      <LokatyClient
